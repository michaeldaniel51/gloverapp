...
package userapi.employer.errors;
...
//
         ...
         */
        @ExceptionHandler(MusicNotOutDatedException.class)
        public ResponseEntity<?> exceptionHandler(MusicNotOutDatedException exception) {
            ErrorResponse errorResponse = new ErrorResponse();
            errorResponse.setTimestamp(LocalDateTime.now().toString());
